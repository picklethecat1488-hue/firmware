    ...
    executor.run(|spawner: embassy_executor::Spawner| {
        controller::spawn_controllers! {
            ...
            controllers: {
                ...
                System(system_ctrl, SYSTEM_CHANNEL, GESTURE_CHANNEL, THERMAL_ACTION_CHANNEL), generics: (controller::SystemController<CriticalSectionRawMutex, DummyFeatureSet<CriticalSectionRawMutex, 16>, 16, 64>),
